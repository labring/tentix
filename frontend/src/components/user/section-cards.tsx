    ...
    <div className="data-[slot=card]:*:shadow-2xs @xl/main:grid-cols-2 @5xl/main:grid-cols-4 grid grid-cols-1 gap-4 px-4 data-[slot=card]:*:bg-linear-to-t data-[slot=card]:*:from-primary/5 data-[slot=card]:*:to-card dark:data-[slot=card]:*:bg-card lg:px-6">
      <Card className="@container/card">
        <CardHeader className="relative">
          <CardDescription>My Open Requests</CardDescription>
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">4 awaiting approval</div>
          <div className="text-muted-foreground">8 in progress</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader className="relative">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">3 scheduled for today</div>
          <div className="text-muted-foreground">5 in active work</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader className="relative">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">2 completed today</div>
          <div className="text-muted-foreground">3 completed this week</div>
        </CardFooter>
      </Card>
      <Card className="@container/card">
        <CardHeader className="relative">
          <CardDescription>Average Resolution</CardDescription>
          <CardTitle className="@[250px]/card:text-3xl text-2xl font-semibold tabular-nums">2.5 days</CardTitle>
          <div className="absolute right-4 top-4">
        ...
        <CardFooter className="flex-col items-start gap-1 text-sm">
          <div className="line-clamp-1 flex gap-2 font-medium">Faster than average</div>
          <div className="text-muted-foreground">Company average: 3.2 days</div>
        </CardFooter>
      </Card>
    </div>
  )
