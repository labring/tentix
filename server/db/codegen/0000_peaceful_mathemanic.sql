...
CREATE TYPE "tentix"."content_block_type" AS ENUM('text', 'image', 'code', 'link', 'mention', 'quote');--> statement-breakpoint
...
CREATE TYPE "tentix"."user_role" AS ENUM('system', 'customer', 'assignee', 'technician', 'admin', 'ai');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "tentix"."message_content_blocks" (
	"id" serial PRIMARY KEY NOT NULL,
	"message_id" integer NOT NULL,
	"type" "tentix"."content_block_type" NOT NULL,
...
ALTER TABLE "tentix"."message_content_blocks" ADD CONSTRAINT "message_content_blocks_message_id_chat_messages_id_fk" FOREIGN KEY ("message_id") REFERENCES "tentix"."chat_messages"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
