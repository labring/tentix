CREATE TYPE "tentix"."dislike_reason" AS ENUM('irrelevant', 'unresolved', 'unfriendly', 'slow_response', 'other');--> statement-breakpoint
...
CREATE TABLE "tentix"."message_feedback" (
	...
	"dislike_reasons" "tentix"."dislike_reason"[] DEFAULT '{}',
...
ALTER TABLE "tentix"."tickets" ADD COLUMN "sealos_namespace" varchar(64) DEFAULT '' NOT NULL;--> statement-breakpoint
...
CREATE INDEX "idx_tickets_customer_id" ON "tentix"."tickets" USING btree ("customer_id");--> statement-breakpoint
CREATE INDEX "idx_tickets_agent_id" ON "tentix"."tickets" USING btree ("agent_id");--> statement-breakpoint
CREATE INDEX "idx_tickets_id_customer" ON "tentix"."tickets" USING btree ("id","customer_id");--> statement-breakpoint
CREATE INDEX "idx_tickets_status" ON "tentix"."tickets" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_tickets_updated_at" ON "tentix"."tickets" USING btree ("updated_at" DESC NULLS LAST);--> statement-breakpoint
