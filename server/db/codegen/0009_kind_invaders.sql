...
INSERT INTO "tentix"."workflow" (
    ...
    '[
        ...
        },
        {
            ...
            "name": "情绪检测",
            "description": "检测用户情绪状态，判断是否需要转人工",
            "config": {
            ...
            "handles": [
                ...
                { "id": "out_handoff",  "type": "source", "position": "right", "condition": "handoffRequired === true" },
                { "id": "out_default",  "type": "source", "position": "right" }
            ]
        },
        {
            "id": "escalation",
            ...
            "name": "询问是否升级",
            "description": "主动询问用户是否需要转接人工技术支持",
            "config": {
            ...
            "handles": [
                { "id": "in",            "type": "target", "position": "left"  },
                { "id": "out_propose",   "type": "source", "position": "right", "condition": "proposeEscalation === true" },
                { "id": "out_continue",  "type": "source", "position": "right" }
            ]
        },
        {
            "id": "handoff",
        ...
        {
            "id": "rag-mh4kjl3x0-k58",
            "type": "rag",
            "position": {
                "x": 343.4270919872408,
                "y": -229.84972782847194
            },
            "name": "rag-mh4kjl3x0-k58",
            "config": {
            ...
            "handles": [
                { "id": "rag-mh4kjl3x0-k58-in-mh4kjl3x1-ew6",  "type": "target", "position": "left"  },
                { "id": "rag-mh4kjl3x0-k58-out-mh4kjl3y2-0t0", "type": "source", "position": "right" }
            ]
        },
        {
            "id": "smart_chat",
    ...
    '[
        ...
        },
        {
            ...
            "target": "handoff",
            "condition": "handoffRequired === true",
            "source_handle": "out_handoff",
            "target_handle": "in"
        },
        {
            "id": "e2_alt",
        ...
        },
        {
            ...
            "source": "escalation",
            "target": "end",
            "condition": "proposeEscalation === true",
            "source_handle": "out_propose",
            "target_handle": "in"
        },
        {
            "id": "e6",
        ...
        {
            "id": "edge-escalation-rag-mh4kjl3x0-k58-out_continue-ew6-mh4kjxsn3-e0z",
            "type": "normal",
            "source": "escalation",
            "target": "rag-mh4kjl3x0-k58",
            "source_handle": "out_continue",
            "target_handle": "rag-mh4kjl3x0-k58-in-mh4kjl3x1-ew6"
        },
        {
            "id": "edge-rag-mh4kjl3x0-k58-smart_chat-0t0-in-mh4kpo094-lgp",
            "type": "normal",
            "source": "rag-mh4kjl3x0-k58",
            "target": "smart_chat",
            "source_handle": "rag-mh4kjl3x0-k58-out-mh4kjl3y2-0t0",
            "target_handle": "in"
        }
    ]'::jsonb,
    NOW(),
